# VCP Example   
This is RF69 and VCP(Virtual Com Port) gateway application.   
...
```
            +------------+          +------------+          +------------+
            | VCP device |          |            |          |            |           |
            |Arduino Uno |--(USB)-->|    ESP32   |--(SPI)-->|    RF69    |==(Radio)==>
            |Arduino Mega|          |            |          |            |
            +------------+          +------------+          +------------+

            +------------+          +------------+          +------------+
            |            |          |            |          | VCP device |
==(Radio)==>|    RF69    |--(SPI)-->|    ESP32   |--(USB)-->|Arduino Uno |
            |            |          |            |          |Arduino Mega|
            +------------+          +------------+          +------------+
```
...
# Configuration
![Image](https://github.com/user-attachments/assets/c7512e44-b224-4627-9b38-30fe86902824)
![Image](https://github.com/user-attachments/assets/64273f14-627d-47e6-9377-c8ce9fae85f8)
